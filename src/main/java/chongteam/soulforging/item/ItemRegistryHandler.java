...
public class ItemRegistryHandler {
    ...
    public static final ItemArmor.ArmorMaterial SOUL_IRON_ARMOR_MATERIAL=EnumHelper.addArmorMaterial("SOUL IRON", SoulForging.MODID+":soul_iron",30, new int[] {3,7,6,3},9, SoundEvents.ITEM_ARMOR_EQUIP_IRON,2);
